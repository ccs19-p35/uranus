...
ENCLAVE_COMMON_SRC = $(HS_COMMON_SRC)/../enclave_src
...
EN_SOURCE_PATHS=\
	$(shell find $(ENCLAVE_COMMON_SRC)/share/vm/* -type d \
	$(foreach dir,$(EN_SPECIAL_PATHS),-not -path $(dir)))
EN_SOURCE_PATHS+=$(ENCLAVE_COMMON_SRC)/os/$(Platform_os_family)/vm
EN_SOURCE_PATHS+=$(ENCLAVE_COMMON_SRC)/os/posix/vm
EN_SOURCE_PATHS+=$(ENCLAVE_COMMON_SRC)/cpu/$(Platform_arch)/vm
EN_SOURCE_PATHS+=$(ENCLAVE_COMMON_SRC)/os_cpu/$(Platform_os_arch)/vm
...
PANOPLY_PATHS := $(ENCLAVE_COMMON_SRC)/share/Panoply/IO $(HS_COMMON_SRC)/share/Panoply/Net
PANOPLY_PATHS += $(ENCLAVE_COMMON_SRC)/share/Panoply/SysEnvironment
PANOPLY_PATHS += $(ENCLAVE_COMMON_SRC)/share/Panoply/Thread
PANOPLY_PATHS += $(ENCLAVE_COMMON_SRC)/share/Panoply/TrustedLibrary
PANOPLY_PATHS += $(ENCLAVE_COMMON_SRC)/share/Panoply/
...
ENCLAVE_PATHS := $(ENCLAVE_COMMON_SRC)/share/PanoplyEnclave/Thread $(ENCLAVE_COMMON_SRC)/share/PanoplyEnclave/cpp $(ENCLAVE_COMMON_SRC)/share/PanoplyEnclave/IO $(ENCLAVE_COMMON_SRC)/share/PanoplyEnclave/EnclaveUtil $(ENCLAVE_COMMON_SRC)/share/PanoplyEnclave $(ENCLAVE_COMMON_SRC)/share/vm/enclave/sc
ENCLAVE_COMPILER := $(EN_CORE_PATHS) $(ENCLAVE_COMMON_SRC)/share/vm/interpreter
...
ENCLAVE_Obj_Files = $(sort $(basename $(addsuffix .cpp,$(ENCLAVE_Src_Files))))
...
ENCLAVE_INCLUDE := -I$(ENCLAVE_COMMON_SRC)/share/PanoplyEnclave/include
ENCLAVE_SYS_INCLUDE := -I$(ENCLAVE_COMMON_SRC)/share/PanoplyEnclave/syscall_include
...
securecompiler_u.c: $(SGX_EDGER8R) $(MAKEFILES_DIR)/enclave/securecompiler.edl
	@$(SGX_EDGER8R) --use-prefix --untrusted $(MAKEFILES_DIR)/enclave/securecompiler.edl \
...
$(Signed_Enclave_Name): $(MAKEFILES_DIR)/enclave/securecompiler.edl
	@mkdir build_enclave
	@cd build_enclave
	$(PRE_HW) cmake $(HS_COMMON_SRC)/../
	$(PRE_HW) make
