...
%.o: %.cpp
	...
	$(QUIETLY) $(COMPILE.CXX) $(DEP_EXT) $(DEPFLAGS) -o $@ $< $(COMPILE_DONE)
else
%.o: %.cpp
	@echo Compiling $<
	$(QUIETLY) $(REMOVE_TARGET)
	$(QUIETLY) $(if $(findstring $@, $(NONPIC_OBJ_FILES)), \
	   $(subst $(VM_PICFLAG), ,$(COMPILE.CXX)) $(DEP_EXT) $(DEPFLAGS) -o $@ $< $(COMPILE_DONE), \
	   $(COMPILE.CXX) $(DEP_EXT) $(DEPFLAGS) -o $@ $< $(COMPILE_DONE))
endif
