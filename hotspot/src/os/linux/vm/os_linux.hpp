...
#define sys_error(A)
  static struct sigaction *(*get_signal_action)(int);
  static struct sigaction *get_preinstalled_handler(int);
  static void save_preinstalled_handler(int, struct sigaction&) { sys_error(); }

  static void check_signal_handler(int sig) { sys_error(); }
 ...
 protected:
  ...
  static char* reserve_memory_special_shm(size_t bytes, size_t alignment, char* req_addr, bool exec);
  static char* reserve_memory_special_huge_tlbfs(size_t bytes, size_t alignment, char* req_addr, bool exec);
  static char* reserve_memory_special_huge_tlbfs_only(size_t bytes, char* req_addr, bool exec) { sys_error(); }
  static char* reserve_memory_special_huge_tlbfs_mixed(size_t bytes, size_t alignment, char* req_addr, bool exec) { sys_error(); }

  static bool release_memory_special_impl(char* base, size_t bytes) { sys_error(); }
  static bool release_memory_special_shm(char* base, size_t bytes) { sys_error(); }
  static bool release_memory_special_huge_tlbfs(char* base, size_t bytes) { sys_error(); }
 ...
 public:
  ...
  static int get_our_sigflags(int) { sys_error(); }
  static void set_our_sigflags(int, int) { sys_error(); }
  static void signal_sets_init();
  static void install_signal_handlers() { sys_error(); }
  static void set_signal_handler(int, bool) { sys_error(); }
  static bool is_sig_ignored(int sig);
  ...
  // For signal-chaining
  static struct sigaction *get_chained_signal_action(int sig) { sys_error(); }
  static bool chained_handler(int sig, siginfo_t* siginfo, void* context) { sys_error(); }
  ...
  // Stack overflow handling
  static bool manually_expand_stack(JavaThread * t, address addr);
  static int max_register_window_saves_before_flushing() { sys_error(); }
  ...
  // LinuxThreads work-around for 6292965
  static int safe_cond_timedwait(pthread_cond_t *_cond, pthread_mutex_t *_mutex, const struct timespec *_abstime) { sys_error(); }
