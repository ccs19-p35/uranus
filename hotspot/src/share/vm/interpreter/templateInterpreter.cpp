...
address    TemplateInterpreter::_throw_forward_entry                        = NULL;
...
#ifdef ENCLAVE_UNIX
  Interpreter::_entry_table[Interpreter::sgx_ocall_entry] = (address)EnclaveOcallRuntime::ocall_addr;
#endif
