...
JVM_BytesEncrypt(JNIEnv *env, jclass ignore, jbyteArray array, jboolean en);

JNIEXPORT jbyteArray JNICALL
JVM_BytesDecrypt(JNIEnv *env, jclass ignore, jbyteArray array, jboolean en);

JNIEXPORT jbyteArray JNICALL
JVM_BytesEncryptInt(JNIEnv *env, jclass ignore, jintArray array, jboolean en);

JNIEXPORT jintArray JNICALL
JVM_BytesDecryptInt(JNIEnv *env, jclass ignore, jbyteArray array, jboolean en);

JNIEXPORT jbyteArray JNICALL
JVM_BytesEncryptDouble(JNIEnv *env, jclass ignore, jdoubleArray array, jboolean en);

JNIEXPORT jdoubleArray JNICALL
JVM_BytesDecryptDouble(JNIEnv *env, jclass ignore, jbyteArray array, jboolean en);

JNIEXPORT jbyteArray JNICALL
JVM_BytesHash(JNIEnv *env, jclass ignore, jbyteArray array, jboolean en);

JNIEXPORT jboolean JNICALL
JVM_BytesHashVerify(JNIEnv *env, jclass ignore, jbyteArray array, jbyteArray hash);

JNIEXPORT void JNICALL
JVM_EnclaveDebug(JNIEnv *env, jclass ignore, jbyteArray array);

JNIEXPORT jobject JNICALL
JVM_EnclaveCopy(JNIEnv *env, jclass ignore, jobject handle);

JNIEXPORT jobject JNICALL
JVM_EnclaveDeepCopy(JNIEnv *env, jclass ignore, jobject handle);
...
JNIEXPORT void JNICALL
JVM_EnclaveSetArrayElement(JNIEnv *env, jclass ignore,jobject arr, jint index, jobject val);
...
JNIEXPORT jobject JNICALL
JVM_EnclaveNewArray(JNIEnv *env, jclass mirror, jclass eltClass, jint length);

JNIEXPORT jobject JNICALL
JVM_NewMultiArray(JNIEnv *env, jclass eltClass, jintArray dim);

JNIEXPORT jobject JNICALL
JVM_EnclaveNewMultiArray(JNIEnv *env, jclass mirror, jclass eltClass, jintArray dim);
