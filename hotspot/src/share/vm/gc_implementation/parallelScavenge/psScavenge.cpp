...
bool PSScavenge::invoke() {
  ...
  if (PSPromotionManager::_enclave_task != NULL) {
      PSPromotionManager::_enclave_task->clear();
  }
...
#ifndef ENCLAVE_UNIX
  CompilerEnclave::compiler_gc(PSPromotionManager::_enclave_task);
#endif
//  printf("gc memory in enclave is %ld\n", (long)PSPromotionManager::_enclave_task->size());
  return full_gc_done;
}
