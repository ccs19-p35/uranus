...
#define VM_SYMBOL_ENUM(name, string) EXCEPTION_EUNM(name),
...
{ EnclaveException::throw_msg(THREAD, name, __FILE__, __LINE__); return; }

#define ENCLAVE_THROW_0(name) \
{ EnclaveException::throw_msg(THREAD, name, __FILE__, __LINE__); return 0; }
