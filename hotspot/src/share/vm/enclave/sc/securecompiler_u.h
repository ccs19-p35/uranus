...
sgx_status_t securecompiler_c1_initialize(sgx_enclave_id_t eid, void** retval, void* cpuid, void** top, void** bottom, void** klass_list, int debug);
...
sgx_status_t securecompiler_interpreted_entry_zero_locals(sgx_enclave_id_t eid, void** retval, void* rbx, void* method, int* has_exception);
